package com.org.moer.Pattern.builder;


/**
 * 描述: [类型　在了解之前，先假设有一个问题，我们需要创建一个学生对象，
 ...
 * 难道我们写6个1个输入的构造函数，15个2个输入的构造函数.......吗？这个时候就需要用到Builder模式了。给个例子，大家肯定一看就懂：描述]
 * <p>文件名称: Builder.java </p>
...
public class Builder {
    ...
    public static void main(String[] args) {
        Student.StudentBuilder a = new Student.StudentBuilder().setAge(12);
